<?php /* Smarty version Smarty-3.1.19, created on 2017-02-26 02:17:43
         compiled from "/home/sites/amadoudiop.com/prestashop-prod/themes/default-amadoudiop/contrat-intervention-technique-signature.tpl" */ ?>
<?php /*%%SmartyHeaderCode:185249805958aec487927a76-09803921%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e7f235b2983d9344def22f6f409c7241288714a6' => 
    array (
      0 => '/home/sites/amadoudiop.com/prestashop-prod/themes/default-amadoudiop/contrat-intervention-technique-signature.tpl',
      1 => 1488071860,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '185249805958aec487927a76-09803921',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_58aec4879443a5_18073366',
  'variables' => 
  array (
    'entreprise_nom' => 0,
    'entreprise_siret' => 0,
...
<?php if ($_valid && !is_callable('content_58aec4879443a5_18073366')) {function content_58aec4879443a5_18073366($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/sites/amadoudiop.com/prestashop-prod/tools/smarty/plugins/modifier.date_format.php';
?><div id="printcontent"><!-- zone imprimable -->
<h2>Contrat d'intervention technique</h2>
<div class="contrat">
  <div class="contrat-content">
<p>
<?php $_smarty_tpl->smarty->loadPlugin('Smarty_Internal_Debug'); Smarty_Internal_Debug::display_debug($_smarty_tpl); ?>
L' entreprise <?php echo mb_strtoupper($_smarty_tpl->tpl_vars['entreprise_nom']->value, 'UTF-8');?>
,<br/> SIRET: <?php echo $_smarty_tpl->tpl_vars['entreprise_siret']->value;?>
,<br /> ayant son siège social
à <?php echo $_smarty_tpl->tpl_vars['entreprise_add1']->value;?>
 <?php echo $_smarty_tpl->tpl_vars['entreprise_add2']->value;?>
 <?php echo $_smarty_tpl->tpl_vars['entreprise_codepost']->value;?>
 <?php echo $_smarty_tpl->tpl_vars['entreprise_ville']->value;?>
, <?php echo $_smarty_tpl->tpl_vars['entreprise_pays']->value;?>
,<br/> prise en la personne de Amadou Diop, dirigeant<br />
<br />
...
<p>
L' entreprise <?php echo mb_strtoupper($_smarty_tpl->tpl_vars['customer_company']->value, 'UTF-8');?>
,<br/>
SIRET: <?php echo $_smarty_tpl->tpl_vars['customer_siret']->value;?>
,<br /> ayant son siège social
à <?php echo $_smarty_tpl->tpl_vars['customer_address']->value[0]['address1'];?>
<?php if (isset($_smarty_tpl->tpl_vars['customer_address']->value[0]['address2'])) {?> <?php echo $_smarty_tpl->tpl_vars['customer_address']->value[0]['address2'];?>
<?php }?> <?php echo $_smarty_tpl->tpl_vars['customer_address']->value[0]['postcode'];?>
 <?php echo $_smarty_tpl->tpl_vars['customer_address']->value[0]['city'];?>
 <?php echo $_smarty_tpl->tpl_vars['customer_country']->value;?>
, <br/>prise en la personne de <?php echo $_smarty_tpl->tpl_vars['customerName']->value;?>
<br />
,<br />
<br />Ci-après dénommé le Client,<br /><br />
</p>
<br />
<p>
...
<p>
Fait à <?php echo $_smarty_tpl->tpl_vars['geolocation_city']->value;?>
, <?php echo mb_strtoupper($_smarty_tpl->tpl_vars['geolocation_country']->value, 'UTF-8');?>
 <br />
Le <?php echo smarty_modifier_date_format(time(),'%d/%m/%Y');?>
...
<div id="content">
	<div id="signatureparent">
		<div class="border" id="signature"></div></div>
	<div id="tools"></div>
...
<input type="hidden" id="id_cart" value="<?php echo $_smarty_tpl->tpl_vars['id_cart']->value;?>
" />
...
</div><!-- fin zone imprimable -->

<button class="button btn btn-default standard-checkout button-medium exclusive" value='Print' id="btnPrint">Imprimer</button>
<button class="button btn btn-default standard-checkout button-medium exclusive" type="button" onclick="$('#signature').jSignature('clear')">Effacer la signature</button>
<button class="button btn btn-default standard-checkout button-medium" type="button" id="btnSave">Valider le contrat</button>
</div>
...
<script>
    $(document).ready(function() {
      $('#btnPrint').click(function printDiv()
          {
            var printcontent=document.getElementById('printcontent');
            var newWin=window.open('','Print-Window');
            newWin.document.open();
            newWin.document.write('<html><body onload="window.print()">'+printcontent.innerHTML+'</body></html>');
            newWin.document.close();
            window.location.href = "/commande?step=2";
          }
      )
      var $sigdiv = $("#signature").jSignature();

        $('#btnSave').click(function(){
            var sigData = $('#signature').jSignature('getData','image/svg+xml;base64');
            $('#hiddenSigData').val(sigData);
            $.ajax({
                type: 'POST',
                url: '{$base_dir_ssl}commande?controller=order',
                dataType: 'JSON',
                data: {
                   action : 'postProcess',
                   ajax : true,
               ...
               {
                    if (data ==''){
                     alert('Votre signature est obligatoire ! Merci de signer le contrat...');
                      } else {
                        console.log(data);
...
<br />
Le présent contrat, votre signature électronique et l'adresse IP de votre machine sont cryptés et sauvegardés dans notre base de donnée à date du jour.
<br /><br />
<p>
