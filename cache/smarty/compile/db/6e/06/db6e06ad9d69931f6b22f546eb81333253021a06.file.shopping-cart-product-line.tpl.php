<?php /* Smarty version Smarty-3.1.19, created on 2017-02-23 12:20:18
         compiled from "/home/sites/amadoudiop.com/prestashop-prod/themes/default-amadoudiop/shopping-cart-product-line.tpl" */ ?>
<?php /*%%SmartyHeaderCode:176677437558aec572666163-28248624%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'db6e06ad9d69931f6b22f546eb81333253021a06' => 
    array (
      0 => '/home/sites/amadoudiop.com/prestashop-prod/themes/default-amadoudiop/shopping-cart-product-line.tpl',
      1 => 1487591172,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '176677437558aec572666163-28248624',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58aec572854576_22705750',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58aec572854576_22705750')) {function content_58aec572854576_22705750($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/sites/amadoudiop.com/prestashop-prod/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_modifier_regex_replace')) include '/home/sites/amadoudiop.com/prestashop-prod/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
<?php $_tmp4=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp2."&amp;ipa=".$_tmp3."&amp;id_address_delivery=".$_tmp4."&amp;op=down&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp7=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp5."&amp;ipa=".$_tmp6."&amp;id_address_delivery=".$_tmp7."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp10=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp8."&amp;ipa=".$_tmp9."&amp;id_address_delivery=".$_tmp10."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
