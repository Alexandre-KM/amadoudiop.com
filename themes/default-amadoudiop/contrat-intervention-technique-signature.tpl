...
<p>
{debug}
L' entreprise {$entreprise_nom|upper},<br/> SIRET: {$entreprise_siret},<br /> ayant son siège social
à {$entreprise_add1} {$entreprise_add2} {$entreprise_codepost} {$entreprise_ville}, {$entreprise_pays},<br/> prise en la personne de Amadou Diop, dirigeant<br />
<br />
...
<p>
L' entreprise {$customer_company|upper},<br/>
SIRET: {$customer_siret},<br /> ayant son siège social
à {$customer_address[0].address1}{if isset($customer_address[0].address2)} {$customer_address[0].address2}{/if} {$customer_address[0].postcode} {$customer_address[0].city} {$customer_country}, <br/>prise en la personne de {$customerName}<br />
,<br />
...
<p>
Fait à {$geolocation_city}, {$geolocation_country|upper} <br />
Le {$smarty.now|date_format:'%d/%m/%Y'} à {$smarty.now|date_format:'%Hh%M'}<br />
<br />
