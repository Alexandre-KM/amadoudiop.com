...
<form method="POST" action="{$payzen_request_uri|escape:'html':'UTF-8'}" class="defaultForm form-horizontal">
  <div style="width: 100%;">
    <fieldset>
      ...
      {l s='Module version' mod='payzen'} : <b>{if $smarty.const._PS_HOST_MODE_|defined}Cloud{/if}1.8.0</b><br/>
      {l s='Platform version' mod='payzen'} : <b>V2</b><br/>
      <a style="color: red;" href="../modules/payzen/installation_doc/Integration_PayZen_PrestaShop_1.5-1.7_v1.8.0.pdf" target="_blank">
  ...
  <div id="accordion" style="width: 100%; float: none;">
    ...
    <div>
      ...
      <fieldset>
        ...
        <div class="margin-form">
          <input type="text" id="PAYZEN_SITE_ID" name="PAYZEN_SITE_ID" value="{$PAYZEN_SITE_ID|escape:'html':'UTF-8'}" />
        ...
        <div class="margin-form">
          <input type="text" id="PAYZEN_KEY_TEST" name="PAYZEN_KEY_TEST" value="{$PAYZEN_KEY_TEST|escape:'html':'UTF-8'}" />
        ...
        <div class="margin-form">
          <input type="text" id="PAYZEN_KEY_PROD" name="PAYZEN_KEY_PROD" value="{$PAYZEN_KEY_PROD|escape:'html':'UTF-8'}" />
      ...
      <fieldset>
        ...
        <div class="margin-form">
          ...
          <p>{l s='The theme configuration to customize the payment page (logo, css).' mod='payzen'}</p>
        </div>
          ...
          <div class="margin-form">
            <select id="PAYZEN_SEND_SHIP_DATA" name="PAYZEN_SEND_SHIP_DATA">
              {foreach from=$payzen_yes_no_options key="key" item="option"}
                <option value="{$key|escape:'html':'UTF-8'}"{if $PAYZEN_SEND_SHIP_DATA === (string)$key} selected="selected"{/if}>{$option|escape:'html':'UTF-8'}</option>
              {/foreach}
            </select>
          ...
          <div class="margin-form">
            ...
            <thead>
              <tr>
                ...
                <th>{l s='FacilyPay Oney label' mod='payzen'}</th>
                <th>{l s='Type' mod='payzen'}</th>
                <th>{l s='Speed' mod='payzen'}</th>
                <th style="width: 270px;">{l s='Address' mod='payzen'}</th>
              </tr>
            </thead>
            <tbody>
              {foreach from=$prestashop_carriers item="carrier"}
                ...
                <tr>
                  ...
                  <td>
                    <select id="PAYZEN_ONEY_SHIP_OPTIONS_{$carrier_id|escape:'html':'UTF-8'}_speed" name="PAYZEN_ONEY_SHIP_OPTIONS[{$carrier_id|escape:'html':'UTF-8'}][speed]">
                  ...
                  <td>
                    <input id="PAYZEN_ONEY_SHIP_OPTIONS_{$carrier_id|escape:'html':'UTF-8'}_address"
                        ...
                        style="width: 270px;{if !isset($ship_option) || $ship_option.type != 'RECLAIM_IN_SHOP'} display: none;{/if}"
                        type="text">
                  </td>
                </tr>
              {/foreach}
            ...
            <p>
              {l s='Define the FacilyPay Oney information about all shipping methods.' mod='payzen'}<br />
              <b>{l s='FacilyPay Oney label' mod='payzen'} : </b>{l s='The label of the shipping method (use 55 alphanumeric characters, accentuated characters and these special characters: space, slash, hyphen, apostrophe).' mod='payzen'}<br />
              <b>{l s='Type' mod='payzen'} : </b>{l s='The delivery type of shipping method.' mod='payzen'}<br />
              <b>{l s='Speed' mod='payzen'} : </b>{l s='Select whether the delivery is STANDARD or EXPRESS.' mod='payzen'}<br />
    ...
    <div>
      <fieldset>
        ...
        <label>{l s='Method title' mod='payzen'}</label>
        <div class="margin-form">
          {include file="./input_text_lang.tpl"
            languages=$prestashop_languages
            current_lang=$prestashop_id_lang
      ...
      <fieldset>
        ...
        <div class="margin-form">
          <select id="PAYZEN_STD_PROPOSE_ONEY" name="PAYZEN_STD_PROPOSE_ONEY">
            {foreach from=$payzen_yes_no_options key="key" item="option"}
              <option value="{$key|escape:'html':'UTF-8'}"{if $PAYZEN_STD_PROPOSE_ONEY === (string)$key} selected="selected"{/if}>{$option|escape:'html':'UTF-8'}</option>
            {/foreach}
          </select>
    ...
    <div>
      ...
      <fieldset>
        ...
        <div class="margin-form">
          <script type="text/html" id="payzen_row_multi_option">
          ...
          <button type="button" id="payzen_multi_options_btn"{if !empty($PAYZEN_MULTI_OPTIONS)} style="display: none;"{/if} onclick="javascript: payzenAddOption(true, '{l s='Delete' mod='payzen'}');">{l s='Add' mod='payzen'}</button>
          ...
          <tbody>
            ...
            <tr id="payzen_multi_option_add">
              <td colspan="7"></td>
              <td>
                <button type="button" onclick="javascript: payzenAddOption(false, '{l s='Delete' mod='payzen'}');">{l s='Add' mod='payzen'}</button>
              </td>
            </tr>
          </tbody>
          </table>
