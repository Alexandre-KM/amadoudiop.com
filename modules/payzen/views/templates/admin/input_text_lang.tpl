...
{foreach from=$languages item=language}
  ...
  <div class="translatable-field lang-{$language.id_lang|escape:'html':'UTF-8'}"
     ...
     style="{if $v5}float: left;{/if}{if $language.id_lang != $current_lang} display: none;{elseif !$v5} display: inline;{/if}">
    <input type="text"
...
{if count($languages) > 1}
  {if version_compare($smarty.const._PS_VERSION_, '1.6', '<')}
    <div class="displayed_flag">
      <img src="../img/l/{$current_lang|escape:'html':'UTF-8'}.jpg" class="pointer" id="language_current_{$field_id|escape:'html':'UTF-8'}" onclick="toggleLanguageFlags(this);" alt="" />
    </div>
    ...
    <div class="bootstrap translation-btn" style="vertical-align: middle; display: inline-block;">
      <div class="col-lg-2">
        <button type="button" class="btn btn-default dropdown-toggle" tabindex="-1" data-toggle="dropdown">
          <span>{$language.iso_code|escape:'html':'UTF-8'}</span>
